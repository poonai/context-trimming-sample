...
class BamlAsyncClient:
    ...
    async def MathChat(self, message_history: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> types.AgentResponse:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.MathChat(message_history=message_history,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="MathChat", args={
                "message_history": message_history,
            })
            return typing.cast(types.AgentResponse, result.cast_to(types, types, stream_types, False, __runtime__))
    async def SummarizeContext(self, message_history: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> typing.List[str]:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.SummarizeContext(message_history=message_history,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="SummarizeContext", args={
                "message_history": message_history,
            })
...
class BamlStreamClient:
    ...
    def MathChat(self, message_history: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.AgentResponse, types.AgentResponse]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="MathChat", args={
            "message_history": message_history,
        })
    ...
    def SummarizeContext(self, message_history: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[typing.List[str], typing.List[str]]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="SummarizeContext", args={
            "message_history": message_history,
        })
...
class BamlHttpRequestClient:
    ...
    async def MathChat(self, message_history: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="MathChat", args={
            "message_history": message_history,
        }, mode="request")
        return result
    async def SummarizeContext(self, message_history: typing.List[str],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="SummarizeContext", args={
            "message_history": message_history,
        }, mode="request")
        return result
