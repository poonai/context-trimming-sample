...
class BamlSyncClient:
    ...
    def MathChat(self, message_history: typing.List[str],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="MathChat", args={
    ...
    def SummarizeContext(self, message_history: typing.List[str],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="SummarizeContext", args={
                "message_history": message_history,
            })
...
class BamlStreamClient:
    ...
    def MathChat(self, message_history: typing.List[str],
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="MathChat", args={
            "message_history": message_history,
        })
    ...
    def SummarizeContext(self, message_history: typing.List[str],
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="SummarizeContext", args={
            "message_history": message_history,
        })
...
class BamlHttpRequestClient:
    ...
    def MathChat(self, message_history: typing.List[str],
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="MathChat", args={
            "message_history": message_history,
        }, mode="request")
        return result
    def SummarizeContext(self, message_history: typing.List[str],
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="SummarizeContext", args={
            "message_history": message_history,
        }, mode="request")
        return result
